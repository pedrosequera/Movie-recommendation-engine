---
title: "Intent_HQ_Markdown_Cosine_Big_Dataset_Genome"
output:
...
Final results are based on the **Cosine** distance metric
...
```{r knn algorithm}
p = find_knn(final.df[,-1],10,distance = "cosine")
...
write.csv(top10_nn_final,paste0(path,"Top10nn_cosine_big_genome.csv"))
write.csv(top10_nn_final_dist,paste0(path,"Top10nn_cosine_big_genome_dist.csv"))
```
...
top10_nn_function = function(title){
  ...
  names(top10.df) = c("Top 10 Movie Titles","Cosine Distance")
